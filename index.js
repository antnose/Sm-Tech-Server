...
async function run() {
    try {
      ...
      `,
        ...
        //----------------  SendGrid End -----------------
        // ------------------Start SendGrid for Send Message to Subscribe for newsletter -----------------
        app.post("/api/subscribe", async (req, res) => {
            ...
            const msg = {
                to: process.env.TO_EMAIL,
                from: process.env.FROM_EMAIL,
                subject: "New Phone Subscription",
                text: `You have a new phone subscriber: ${phone}`,
                html: `
        <div style="font-family: Arial; padding: 10px;">
            <h2>📞 New Phone Subscriber</h2>
        ...
        // ------------------ End SendGrid for Send Message to Subscribe for newsletter -----------------
